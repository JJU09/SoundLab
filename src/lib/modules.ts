...
export const MODULES: ModuleDef[] = [
  ...
  },
  {
    ...
    knobs: [
      { param: 'amount', label: 'Drive', min: 0, max: 100, value: 40, fmt: fPct, tier: 'easy' },
    ],
    defaultSrc: 'tone',
    defaultWave: 'sine',
  },
  {
    ...
    knobs: [
      { param: 'rate', label: 'Rate', min: 0.1, max: 20, value: 5, curve: 'log', fmt: v => v.toFixed(1) + 'Hz', tier: 'easy' },
      { param: 'depth', label: 'Depth', min: 0, max: 100, value: 60, fmt: fPct, tier: 'normal' },
    ],
    defaultSrc: 'tone',
  ...
  },
  {
    ...
    knobs: [
      { param: 'mix', label: 'Mix', min: 0, max: 100, value: 50, fmt: fPct, tier: 'easy' },
      { param: 'rate', label: 'Rate', min: 0.1, max: 8, value: 1.5, curve: 'log', fmt: v => v.toFixed(1) + 'Hz', tier: 'normal' },
      { param: 'depth', label: 'Depth', min: 0, max: 100, value: 50, fmt: fPct, tier: 'normal' },
    ],
    defaultSrc: 'pluck',
  },
  {
    ...
    knobs: [
      { param: 'time', label: 'Time', min: 0.02, max: 1.2, value: 0.3, curve: 'log', fmt: fMs, tier: 'easy' },
      { param: 'feedback', label: 'Feedback', min: 0, max: 90, value: 40, fmt: fPct, tier: 'normal' },
      { param: 'mix', label: 'Mix', min: 0, max: 100, value: 35, fmt: fPct, tier: 'normal' },
    ],
    defaultSrc: 'pluck',
  },
  {
    ...
    knobs: [
      { param: 'size', label: 'Size', min: 0.3, max: 4, value: 1.8, fmt: v => v.toFixed(1) + 's', tier: 'easy' },
      { param: 'mix', label: 'Mix', min: 0, max: 100, value: 30, fmt: fPct, tier: 'normal' },
    ],
    defaultSrc: 'pluck',
  },
];
